...
Stepper_lb1838 myStepperY(stepsPerRevolution, 2, 3, 4);
Stepper_lb1838 myStepperX(stepsPerRevolution, 5, 6, 7);
...
enum CNCState {StandBy, Printing, Paused};
CNCState currentState = StandBy;
int sensorPin = A2;
int sensorValue = 0;
...
void setup() {
  ...
  myStepperX.setStandBy();
  myStepperY.setStandBy();
}
      ...
      case 'G':
        ...
        switch ( atoi( buffer ) ) {                  // Select G command
          ...
          case 1:
            ...
            char* indexZ = strchr( line + currentIndex, 'Z' ); // Up/Down
            Serial.print( "indexX " );
            Serial.println( indexX );
            Serial.print( "indexY " );
            Serial.println( indexY );
            Serial.print( "indexZ " );
            ...
            if ( indexZ <= 0 ) {
              ...
              if ( indexX <= 0 )
              {
                break; // if no  break; it goto ox 0y
              }
